...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var fetchTasks = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = 'https://module3-api-is2m.onrender.com/random-todos';
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("Error fetcheing task:", error_1);
                    throw (error_1);
    ...
    function addTask() {
        ...
        var taskItem = createTask(taskTitle);
        taskList.appendChild(taskItem);
        newTaskInput.value = '';
    }
    ...
    // Fetch tasks from API
    fetchTasks()
        .then(function (tasks) { return tasks.slice(0, 3); })
        .then(displayTask)
        .catch(function (error) { return console.error("Error fetching and displaying task:", error); });
});
